...
class CumulusSwitch(NetWeaverPlugin):
	...
	# 		cstate = self.cstate
	# 		self.add_command(self._hostname_push(dstate, cstate))
	# 		self.add_command(self._protocol_dns_nameservers_push(dstate, cstate))
	# 		self.add_command(self._protocol_ntpclient_timezone_push(dstate, cstate))
	# 		self.add_command(self._protocol_ntpclient_servers(dstate, cstate))
	# 		self.add_command(self._vlans_push(dstate, cstate))
	# 		self.add_command(self._interfaces_push(dstate, cstate))
	#
